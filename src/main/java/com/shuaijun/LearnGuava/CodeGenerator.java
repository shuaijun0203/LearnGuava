...
public class CodeGenerator {
    ...
    public static String scanner(String tip) {
        ...
        throw new MybatisPlusException("The correct information is " + tip + "！");
    }
...
//        gc.setOutputDir("D:\\test");
        ...
        pc.setParent("com.shuaijun.LearnGuava");
        ...
        strategy.setInclude(scanner("table's name，divided by comma").split(","));
